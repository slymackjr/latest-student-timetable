                      ...
                      <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                        <div className="d-flex flex-row align-items-center mb-3">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="text" className="form-control bg-white" name="regno" placeholder="Your Registration Number" required/>
                          </div>
                        </div>
                        ...
                        <div className="d-flex flex-row align-items-center mb-3">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="password" className="form-control bg-white" name="password" placeholder="Password" required />
                          </div>
                        </div>
