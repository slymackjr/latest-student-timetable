                        ...
                        <div className="mask">
                          <div className="d-flex justify-content-center align-items-center h-100">
                            <div className="text-black">
                              <Link to="/login-staff" className="btn btn-outline-danger btn-lg m-2 text-white" role="button" rel="nofollow">Login Staff</Link>
                              <Link to="/login-student" className="btn btn-outline-danger btn-lg m-2 text-white" role="button">Login student</Link>
                            </div>
                          </div>
                        </div>
                      </div>
